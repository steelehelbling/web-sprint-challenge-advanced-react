...
class Main extends Component {//declare class
 constructor() {
   super()
 ...
 render() {
   <BooksList books={this.state.books} />//set to state may need to map dependant on data
 }
}
...
render() is used to render the elements to the screen this is where you put you’re react html
...
find the component you want to test get some form of id then in testing find the location of the component you want to test make a event and change text click button ect then do and expect to see if test was successful
